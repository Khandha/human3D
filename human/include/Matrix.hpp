...
/* Matrices typedefs */
using mat4 = Mat2d<float, 4, 4>;
using mat3 = Mat2d<float, 3, 3>;
using mat2 = Mat2d<float, 2, 2>;
/* Vectors typedefs */
using vec4 = Mat2d<float, 4, 1>;
using vec3 = Mat2d<float, 3, 1>;
using vec2 = Mat2d<float, 2, 1>;
using vec4d = Mat2d<double, 4, 1>;
using vec3d = Mat2d<double, 3, 1>;
using vec2d = Mat2d<double, 2, 1>;
