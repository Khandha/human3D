...
void Model::initBufferObjects(int mode, eModelType modelType)
{
    ...
    switch (modelType)
    {
    case eModelType::cube: createCube(vertices, indices);
        break;
    case eModelType::sphere: createSphere(vertices, indices, 0.5f, 40, 40);
        break;
    case eModelType::cylinder: createSphere(vertices, indices, 0.6f, 4, 40);
        break;
    default: break;
    }
